...
ANSWER : COMPILED, BUT LATER GOT STACK SMASHING ERROR

TASK : FIX THE CODE SO THAT THE RUNTIME ERROR DOES NOT OCCUR
ANSWER : CHANGED THE VECTOR SIZE TO 128 

OPTIONAL TASK : changed float to int, and vector size = 130 
ANSWER : error encountered: error: cannot convert ‘int*’ to ‘const float*’ ... seems like SIMD operations don't work with integers
